      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto">
            Coordinate your monitoring and response efforts. Users can join teams to share
            alerts and monitored areas, ensuring a synchronized and efficient approach.
          </p>
        </div>
        {/* Team Features Section */}
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Key Features for Teams</h2>
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">
                    Seamlessly share monitored areas among your team members. This ensures everyone
                    is focused on the same critical locations, improving situational awareness.
                  </p>
                </div>
              </div>
              <div className="flex items-start">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">
                    Streamline communication and efforts by focusing on the same high-priority
                    alerts and areas as a group.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="w-full h-80 bg-gray-200 rounded-2xl flex items-center justify-center text-gray-500 mb-8">
                      </div>
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Once a member, you gain access to all shared monitoring areas and alerts, enabling
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Work as a cohesive unit to monitor and respond to wildfire incidents within your
